...
CREATE TABLE flights (
    ...
    CONSTRAINT fk_flight_departure_airport FOREIGN KEY (departure_airport_icao) REFERENCES airports_new(icao_code),
    CONSTRAINT fk_flight_arrival_airport FOREIGN KEY (arrival_airport_icao) REFERENCES airports_new(icao_code),
