...
public interface PassengerRepository extends ReactiveCrudRepository<Passenger, Long> {
    ...
    @Query("INSERT INTO passengers (first_name, last_name, passport_number, nationality, email, phone) " +
            "VALUES (:#{#passenger.firstName}, :#{#passenger.lastName}, :#{#passenger.passportNumber}, " +
